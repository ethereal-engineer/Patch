...
@property (nonatomic, copy) void (^dataSourceDidInsertItemBlock)(id <PDSDataSource> dataSource, NSIndexPath *indexPath);
@property (nonatomic, copy) void (^dataSourceDidUpdateItemBlock)(id <PDSDataSource> dataSource, NSIndexPath *indexPath);
@property (nonatomic, copy) void (^dataSourceDidRemoveItemBlock)(id <PDSDataSource> dataSource, NSIndexPath *indexPath);
