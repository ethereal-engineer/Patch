//
//  MGPageViewControllerDataSource.m
//  Mytograph
//
...
@interface MGPageViewControllerDataSource () <MGDataSourceChangeListener>
...
@implementation MGPageViewControllerDataSource
...
- (instancetype)initWithDataSource:(id<MGDataSource>)dataSource placeholderViewController:(UIViewController *)placeholder
{
...
{
    MGPageViewControllerDataSource *pvcd = nil;
    @autoreleasepool
    {
        pvcd = [[MGPageViewControllerDataSource alloc] initWithDataSource:dataSource placeholderViewController:placeholder];
    }
    return pvcd;
}
