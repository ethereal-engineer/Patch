...
#import "MGCoreDataSource.h"

#pragma mark - Composites

#import "MGDataSourceChangeNotifier.h"

@interface MGCoreDataSource () <NSFetchedResultsControllerDelegate>
...
@implementation MGCoreDataSource
...
{
    MGCoreDataSource *dataSource = nil;
    @autoreleasepool
    {
        dataSource = [[MGCoreDataSource alloc] initWithEntityName:name sortDescriptors:sortDescriptors andContext:context];
    }
    return dataSource;
}
...
{
    MGCoreDataSource *dataSource = [self dataSourceWithEntityName:name sortDescriptors:sortDescriptors andContext:context];
